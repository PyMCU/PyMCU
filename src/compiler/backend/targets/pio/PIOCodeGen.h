...
private:
    ...
    std::map<std::string, std::string> register_map; // Maps Variable/Temporary to X or Y
    int label_counter = 0;
    ...
    void emit(const std::string& mnemonic, const std::string& op1, const std::string& op2, const std::string& op3) const;
