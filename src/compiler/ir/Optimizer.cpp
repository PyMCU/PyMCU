    ...
    for (auto &instr: func.body) {
        if (auto *binary = std::get_if<tacky::Binary>(&instr)) {
            ...
            if (c1 && c2) {
                ...
                bool foldable = true;
                switch (binary->op) {
                    case tacky::BinaryOp::Add: result = *c1 + *c2;
                        break;
                    case tacky::BinaryOp::Sub: result = *c1 - *c2;
                        break;
                    case tacky::BinaryOp::Mul: result = *c1 * *c2;
                        break;
                    case tacky::BinaryOp::Div: if (*c2 != 0) result = *c1 / *c2;
                        else foldable = false;
                        break;
                    case tacky::BinaryOp::Mod: if (*c2 != 0) result = *c1 % *c2;
                        else foldable = false;
                        break;
                    case tacky::BinaryOp::Equal: result = (*c1 == *c2);
                        break;
                    case tacky::BinaryOp::NotEqual: result = (*c1 != *c2);
                        break;
                    case tacky::BinaryOp::LessThan: result = (*c1 < *c2);
                        break;
                    case tacky::BinaryOp::LessEqual: result = (*c1 <= *c2);
                        break;
                    case tacky::BinaryOp::GreaterThan: result = (*c1 > *c2);
                        break;
                    case tacky::BinaryOp::GreaterEqual: result = (*c1 >= *c2);
                        break;
                    case tacky::BinaryOp::BitAnd: result = *c1 & *c2;
                        break;
                    case tacky::BinaryOp::BitOr: result = *c1 | *c2;
                        break;
                    case tacky::BinaryOp::BitXor: result = *c1 ^ *c2;
                        break;
                    case tacky::BinaryOp::LShift: result = *c1 << *c2;
                        break;
                    case tacky::BinaryOp::RShift: result = *c1 >> *c2;
                        break;
            ...
            if (c) {
                ...
                bool foldable = true;
                switch (unary->op) {
                    case tacky::UnaryOp::Neg: result = -(*c);
                        break;
                    case tacky::UnaryOp::Not: result = !(*c);
                        break;
                    case tacky::UnaryOp::BitNot: result = ~(*c);
                        break;
                    default: foldable = false;
                        break;
                }
