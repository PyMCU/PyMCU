...
int main(int argc, char *argv[]) {
  ...
  try {
    ...
    // Determine target architecture priority: device_info(arch=) > chip name > CLI
    // Use the explicit architecture name (e.g., "pic14e") for CodeGenFactory
    // when available, since it's more precise than the chip name.
