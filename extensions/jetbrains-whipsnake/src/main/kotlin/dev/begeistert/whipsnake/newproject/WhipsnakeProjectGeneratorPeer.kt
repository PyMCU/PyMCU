...
/**
 * The settings panel shown in PyCharm's New Project wizard for Whipsnake projects.
 *
 ...
 *   5  Hint
 */
class WhipsnakeProjectGeneratorPeer : ProjectGeneratorPeer<WhipsnakeNewProjectSettings> {
    ...
    override fun getSettings(): WhipsnakeNewProjectSettings {
        ...
        return WhipsnakeNewProjectSettings(
            chip           = chip,
            board          = board,
