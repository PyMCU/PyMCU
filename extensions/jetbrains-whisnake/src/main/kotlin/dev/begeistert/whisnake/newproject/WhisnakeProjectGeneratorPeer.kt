...
/**
 * The settings panel shown in PyCharm's New Project wizard for Whisnake projects.
 *
 ...
 *   5  Hint
 */
class WhisnakeProjectGeneratorPeer : ProjectGeneratorPeer<WhisnakeNewProjectSettings> {
    ...
    override fun getSettings(): WhisnakeNewProjectSettings {
        ...
        return WhisnakeNewProjectSettings(
            chip           = chip,
            board          = board,
