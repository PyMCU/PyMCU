package dev.begeistert.whisnake.config
...
object WhisnakeConfigReader {
    ...
    /**
     * Parse [tool.whip] and return a [WhisnakeConfig], or null if the file/section is absent.
     */
    fun findConfig(project: Project): WhisnakeConfig? {
     ...
     */
    fun parseContent(content: String): WhisnakeConfig? {
