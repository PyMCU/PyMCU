package dev.begeistert.whisnake.console
 ...
 */
class WhisnakeConsoleFilter(private val project: Project) : Filter {
...
/**
 * Provides [WhisnakeConsoleFilter] for all run/debug consoles in a project.
 */
class WhisnakeConsoleFilterProvider : ConsoleFilterProvider {
    override fun getDefaultFilters(project: Project): Array<Filter> =
        arrayOf(WhisnakeConsoleFilter(project))
}
