...
/**
 * Reads [tool.pymcu] from pyproject.toml at the project base directory.
...
object PyMCUConfigReader {
    ...
    // FFI section
    private val FFI_RE          = Regex("""\[tool\.pymcu\.ffi]""")
    ...
    fun parseContent(content: String): PyMCUConfig? {
        ...
        // Check for FFI section anywhere in the file
        val hasFfi = lines.any { FFI_RE.containsMatchIn(it) }
