...
def sleep_idle():
    match __CHIP__.name:
        case "atmega328p":
            from whisnake.hal._power.atmega328p import sleep_idle as _sleep_idle
            _sleep_idle()
...
def sleep_adc_noise():
    match __CHIP__.name:
        case "atmega328p":
            from whisnake.hal._power.atmega328p import sleep_adc_noise as _sleep_adc_noise
            _sleep_adc_noise()
...
def sleep_power_down():
    match __CHIP__.name:
        case "atmega328p":
            from whisnake.hal._power.atmega328p import sleep_power_down as _sleep_power_down
            _sleep_power_down()
...
def sleep_power_save():
    match __CHIP__.name:
        case "atmega328p":
            from whisnake.hal._power.atmega328p import sleep_power_save as _sleep_power_save
            _sleep_power_save()
...
def sleep_standby():
    match __CHIP__.name:
        case "atmega328p":
            from whisnake.hal._power.atmega328p import sleep_standby as _sleep_standby
            _sleep_standby()
