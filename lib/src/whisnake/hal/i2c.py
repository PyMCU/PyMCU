...
class I2C:
    ...
    def __init__(self):
        match __CHIP__.arch:
            case "avr":
                from whisnake.hal._i2c.avr import i2c_init
                i2c_init()
    ...
    def ping(self, addr: uint8) -> uint8:
        match __CHIP__.arch:
            case "avr":
                from whisnake.hal._i2c.avr import i2c_ping
    ...
    def start(self) -> uint8:
        match __CHIP__.arch:
            case "avr":
                from whisnake.hal._i2c.avr import i2c_start
                return i2c_start()
            case _:
                return 0
    ...
    def stop(self):
        match __CHIP__.arch:
            case "avr":
                from whisnake.hal._i2c.avr import i2c_stop
                i2c_stop()
    ...
    def write(self, data: uint8) -> uint8:
        match __CHIP__.arch:
            case "avr":
                from whisnake.hal._i2c.avr import i2c_write
    ...
    def read_ack(self) -> uint8:
        match __CHIP__.arch:
            case "avr":
                from whisnake.hal._i2c.avr import i2c_read_ack
                return i2c_read_ack()
            case _:
                return 0
    ...
    def read_nack(self) -> uint8:
        match __CHIP__.arch:
            case "avr":
                from whisnake.hal._i2c.avr import i2c_read_nack
    ...
    def write_to(self, addr: uint8, data: uint8) -> uint8:
        ...
        match __CHIP__.arch:
            case "avr":
                from whisnake.hal._i2c.avr import i2c_write_to
    ...
    def read_from(self, addr: uint8) -> uint8:
        ...
        match __CHIP__.arch:
            case "avr":
                from whisnake.hal._i2c.avr import i2c_read_from
