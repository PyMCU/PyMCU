...
class PWM:
    ...
    def __init__(self, pin: str, duty: uint8):
        match __CHIP__.name:
            case "atmega328p":
                from whisnake.hal._pwm.atmega328p import pwm_init, pwm_select_ocr, pwm_select_tccr_b, pwm_select_start_val
                pwm_init(pin, duty)
                self._ocr       = pwm_select_ocr(pin)
                self._tccr_b    = pwm_select_tccr_b(pin)
                self._start_val = pwm_select_start_val(pin)
            case "pic16f877a":
                from whisnake.hal._pwm.pic16f877a import pwm_init
                self.pin = pin
                pwm_init(pin, duty)
            case "pic16f18877":
                from whisnake.hal._pwm.pic16f18877 import pwm_init
                self.pin = pin
                pwm_init(pin, duty)
            case "pic18f45k50":
                from whisnake.hal._pwm.pic18f45k50 import pwm_init
                self.pin = pin
                pwm_init(pin, duty)
    ...
    def set_duty(self, duty: uint8):
        match __CHIP__.name:
            ...
            case "pic16f877a":
                from whisnake.hal._pwm.pic16f877a import pwm_set_duty
                pwm_set_duty(self.pin, duty)
            case "pic16f18877":
                from whisnake.hal._pwm.pic16f18877 import pwm_set_duty
                pwm_set_duty(self.pin, duty)
            case "pic18f45k50":
                from whisnake.hal._pwm.pic18f45k50 import pwm_set_duty
                pwm_set_duty(self.pin, duty)
    ...
    def start(self):
        match __CHIP__.name:
            ...
            case "pic16f877a":
                from whisnake.hal._pwm.pic16f877a import pwm_start
                pwm_start(self.pin)
            case "pic16f18877":
                from whisnake.hal._pwm.pic16f18877 import pwm_start
                pwm_start(self.pin)
            case "pic18f45k50":
                from whisnake.hal._pwm.pic18f45k50 import pwm_start
                pwm_start(self.pin)
    ...
    def stop(self):
        match __CHIP__.name:
            ...
            case "pic16f877a":
                from whisnake.hal._pwm.pic16f877a import pwm_stop
                pwm_stop(self.pin)
            case "pic16f18877":
                from whisnake.hal._pwm.pic16f18877 import pwm_stop
                pwm_stop(self.pin)
            case "pic18f45k50":
                from whisnake.hal._pwm.pic18f45k50 import pwm_stop
                pwm_stop(self.pin)
