...
class UART:
    ...
    def __init__(self, baud: const[uint16] = 9600):
        match __CHIP__.arch:
            case "avr":
                from whisnake.hal._uart.avr import uart_init
                uart_init(baud)
            case "pic14":
                from whisnake.hal._uart.pic14 import uart_init
                uart_init(baud)
            case "pic18":
                from whisnake.hal._uart.pic18 import uart_init
                uart_init(baud)
    ...
    def write(self, data: uint8):
        match __CHIP__.arch:
            case "avr":
                from whisnake.hal._uart.avr import uart_write
                uart_write(data)
            case "pic14":
                from whisnake.hal._uart.pic14 import uart_write
                uart_write(data)
            case "pic18":
                from whisnake.hal._uart.pic18 import uart_write
                uart_write(data)
    ...
    def read(self) -> uint8:
        match __CHIP__.arch:
            case "avr":
                from whisnake.hal._uart.avr import uart_read
                return uart_read()
            case "pic14":
                from whisnake.hal._uart.pic14 import uart_read
                return uart_read()
            case "pic18":
                from whisnake.hal._uart.pic18 import uart_read
                return uart_read()
    ...
    def write_str(self, s: const[str]):
        match __CHIP__.arch:
            case "avr":
                from whisnake.hal._uart.avr import uart_write_str
                uart_write_str(s)
    ...
    def print_byte(self, value: uint8):
        ...
        match __CHIP__.arch:
            case "avr":
                from whisnake.hal._uart.avr import uart_write_decimal_u8
    ...
    def available(self) -> uint8:
        ...
        match __CHIP__.arch:
            case "avr":
                from whisnake.hal._uart.avr import uart_available
    ...
    def read_nb(self) -> uint8:
        ...
        match __CHIP__.arch:
            case "avr":
                from whisnake.hal._uart.avr import uart_read_nb
                return uart_read_nb()
        return 0
    ...
    def read_byte_isr(self) -> uint8:
        ...
        match __CHIP__.arch:
            case "avr":
                from whisnake.hal._uart.avr import uart_read_byte_isr
    ...
    def enable_rx_interrupt(self):
        ...
        match __CHIP__.arch:
            case "avr":
                from whisnake.hal._uart.avr import uart_enable_rx_interrupt
    ...
    def rx_available(self) -> uint8:
        ...
        match __CHIP__.arch:
            case "avr":
                from whisnake.hal._uart.avr import uart_rx_available
    ...
    def rx_read(self) -> uint8:
        ...
        match __CHIP__.arch:
            case "avr":
                from whisnake.hal._uart.avr import uart_rx_read
                return uart_rx_read()
        return 0
