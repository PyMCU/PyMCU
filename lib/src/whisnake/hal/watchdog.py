...
class Watchdog:
    ...
    def enable(self):
        match __CHIP__.name:
            case "atmega328p":
                from whisnake.hal._watchdog.atmega328p import wdt_enable, wdt_timeout_wdp
    ...
    def disable(self):
        match __CHIP__.name:
            case "atmega328p":
                from whisnake.hal._watchdog.atmega328p import wdt_disable
                wdt_disable()
    ...
    def feed(self):
        ...
        match __CHIP__.name:
            case "atmega328p":
                from whisnake.hal._watchdog.atmega328p import wdt_feed
                wdt_feed()
