...
class BMP280:
    ...
    def init(self):
        match __CHIP__.arch:
            case "avr":
                from whisnake.drivers._bmp280.i2c import bmp280_init
    ...
    def read_temp_raw(self) -> uint16:
        match __CHIP__.arch:
            case "avr":
                from whisnake.drivers._bmp280.i2c import bmp280_read_temp_raw
    ...
    def read_press_raw(self) -> uint16:
        match __CHIP__.arch:
            case "avr":
                from whisnake.drivers._bmp280.i2c import bmp280_read_press_raw
