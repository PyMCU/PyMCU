from whipsnake.chips.atmega328p import TCCR0A, TCCR0B, OCR0A, OCR0B
from whipsnake.chips.atmega328p import TCCR1A, TCCR1B, OCR1AL, OCR1BL
from whipsnake.chips.atmega328p import TCCR2A, TCCR2B, OCR2A, OCR2B
from whipsnake.chips.atmega328p import DDRD, DDRB
from whipsnake.types import uint8, uint16, inline, ptr
