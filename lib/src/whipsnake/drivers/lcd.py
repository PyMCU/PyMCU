...
class LCD:
    ...
    def init(self):
        match __CHIP__.arch:
            case "avr":
                from whipsnake.drivers._lcd.gpio import lcd_init
    ...
    def clear(self):
        match __CHIP__.arch:
            case "avr":
                from whipsnake.drivers._lcd.gpio import lcd_clear
    ...
    def home(self):
        match __CHIP__.arch:
            case "avr":
                from whipsnake.drivers._lcd.gpio import lcd_home
    ...
    def print_str(self, s: const[str]):
        match __CHIP__.arch:
            case "avr":
                from whipsnake.drivers._lcd.gpio import lcd_print_str
    ...
    def set_cursor(self, col: uint8, row: uint8):
        match __CHIP__.arch:
            case "avr":
                from whipsnake.drivers._lcd.gpio import lcd_set_cursor
    ...
    def write_char(self, c: uint8):
        match __CHIP__.arch:
            case "avr":
                from whipsnake.drivers._lcd.gpio import lcd_write_char
