...
class NeoPixel:
    ...
    def __init__(self, pin: str, n: uint8):
        ...
        if __CHIP__.arch == "avr":
            from whipsnake.drivers._neopixel.avr import ws2812_init
            ws2812_init(pin)
    ...
    def set_pixel(self, r: uint8, g: uint8, b: uint8):
        if __CHIP__.arch == "avr":
            from whipsnake.drivers._neopixel.avr import ws2812_write_byte
    ...
    def show(self):
        if __CHIP__.arch == "avr":
            from whipsnake.drivers._neopixel.avr import ws2812_reset
