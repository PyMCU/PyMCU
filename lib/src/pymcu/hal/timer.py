...
if __CHIP__.arch == "avr":
    ...
    if __CHIP__.name in ("attiny85", "attiny45", "attiny25"):
        from pymcu.hal.avr.attiny85_timer import millis_init, millis
    else:
        from pymcu.hal.avr.atmega328p_timer import millis_init, millis
