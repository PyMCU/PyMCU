...
#
# Prescaler selection: the floor of each bucket is the lowest frequency the
# 8-bit OCR2A can reach in toggle mode, F_CPU / (2 * N * 256) = 31250 / N at
# 16 MHz. A request below the floor overflows OCR2A and clamps to the bucket
# minimum (tone(440) came out at 488 Hz on real silicon before this table
# was fixed; the old thresholds were 4x too low).
#   freq >= 31250 Hz -> prescaler 1    (OCR2A = F_CPU / (2 * freq * N) - 1)
#   freq >= 3907 Hz  -> prescaler 8
#   freq >= 977 Hz   -> prescaler 32
#   freq >= 489 Hz   -> prescaler 64
#   freq >= 245 Hz   -> prescaler 128
#   freq >= 123 Hz   -> prescaler 256
