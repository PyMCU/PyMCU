...
TEST(AVRCodeGenTest, IOOptimization) {
    ...
    // PORTB (0x25) = 1
    main_func.body.push_back(tacky::Copy{tacky::Constant{1}, tacky::MemoryAddress{0x25}});
    // DDRB (0x24) bit 0 = 1
...
TEST(AVRCodeGenTest, PeepholeRedundantLDI) {
    ...
    // a = 1
    // b = 1
    main_func.body.push_back(tacky::Copy{tacky::Constant{1}, tacky::Variable{"a"}});
    main_func.body.push_back(tacky::Copy{tacky::Constant{1}, tacky::Variable{"b"}});
