...
from pymcu.types import uint8, uint16, const, asm, inline, interrupt
...
# ---------------------------------------------------------------------------
from pymcu.chips.pic16f18877 import ANSELA, TRISA, ADCON0, ADPCH, ADCLK, ADREF, ADRESH, ADON, GO, PORTD, TRISD, INTCON, GIE, PEIE
