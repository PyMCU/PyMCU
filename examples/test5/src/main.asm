...
nco_init.NCO1CLK EQU _stack_base + 3
nco_init.NCO1CON EQU _stack_base + 4
nco_init.NCO1INC EQU _stack_base + 5
nco_init.inc_val EQU _stack_base + 6
tmp.0 EQU _stack_base + 3
tmp.1 EQU _stack_base + 3
tmp.10 EQU _stack_base + 2
tmp.11 EQU _stack_base + 2
tmp.12 EQU _stack_base + 2
tmp.13 EQU _stack_base + 2
tmp.2 EQU _stack_base + 2
...
; Line 6: 
	MOVLW	0x00
	MOVLB	0
	MOVWF	nco_init.NCO1CON
; Line 10: NOTE_G4 = 49152
	MOVLW	0x01
	MOVWF	nco_init.NCO1CLK
; Line 15: 
	MOVF	nco_init.inc_val, W
	MOVWF	nco_init.NCO1INC
; Line 19: 
	MOVLW	0x81
	MOVWF	nco_init.NCO1CON
	MOVLW	0x00
