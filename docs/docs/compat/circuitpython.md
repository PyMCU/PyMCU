...
The `whipsnake-circuitpython` package lets you write CircuitPython-style firmware that compiles
...
# Whipsnake -- multiply first, divide last
...
| Feature | CircuitPython | Whipsnake flavor |
|---------|---------------|--------------|
